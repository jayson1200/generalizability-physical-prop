...
# 2) Exactly one flag must be set:
...
results_file = "varying_bottle_params.csv"
...
object_location = "assets/objects/bottled_water/model.xml"
tmp_location    = "assets/objects/bottled_water/model_backup.xml"
...
method     = args.method
split      = args.split
env_name   = "EnvBottle-v0-var-scale"
...
scene = envs.base_env.scene.actors["bottle_0"]
...
with torch.inference_mode():
    for _ in tqdm.trange(envs.unwrapped.max_episode_steps):
        ...
        current_bottle_net_contact_forces = envs.base_env.scene.actors["bottle_0"].get_net_contact_forces().cpu().numpy()
